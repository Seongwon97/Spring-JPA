...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("JPA master", 10000, "성원", 10);
    ...
    public void 상품주문_재고수량초과() throws Exception {
        // given
        Member member = createMember("회원1");
        Item item = createBook("JPA master", 10000, "성원", 10);
        int orderCount = 11;
        ...
        // then
        fail("재고 수량 부족 예외가 발생해야 한다."); // 해당 라인까지 오면 안될 때 추가
    }
    ...
    private Book createBook(String name, int price, String author, int quantity) {
        Book book = new Book();
        book.setName(name);
        book.setPrice(price);
    ...
    private Member createMember(String name) {
        ...
        member.setName(name);
        member.setAddress(new Address("용인", "중부대로", "12345"));
        em.persist(member);
        return member;
    }
}